...
public class TodayActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    public static TodayActivity ma;
...
//        FloatingActionButton
        ...
        myFab.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent i = new Intent(TodayActivity.this, BuatTask.class);
                startActivity(i);
            }
        });
    }
    ...
    public void RefreshList(){
        ...
        cursor = db.rawQuery("SELECT * FROM tugas where target='"+date+"'", null);
        ...
        superHeroAdapter.setOnItemClickListener(new SuperHeroAdapter.ClickListener() {
            ...
            public void onItemClick(int position, View v) {
                ...
                Intent i = new Intent(TodayActivity.this, UpdateTask.class);
